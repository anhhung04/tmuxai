...
# Usage:
#   curl -sfL https://raw.githubusercontent.com/anhhung04/tmuxai/main/install.sh | bash
...
GH_REPO="anhhung04/tmuxai"
PROJECT_NAME="tmuxai"
DEFAULT_INSTALL_DIR="/usr/local/bin"

CONFIG_DIR="$HOME/.config/tmuxai"
CONFIG_FILE="$CONFIG_DIR/config.example.yaml"
EXAMPLE_CONFIG_URL="https://raw.githubusercontent.com/anhhung04/tmuxai/main/config.example.yaml"
